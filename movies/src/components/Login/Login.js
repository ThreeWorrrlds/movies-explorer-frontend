  ...
  return (
    <div className="login">
      ...
      <form className="login__form">
        ...
        <input id="email" type="email" className="login__input input-email" name="email"
          placeholder="E-mail" minLength="3" maxLength="30" required />
        <span className="login__text-error login-email-error"></span>

        <label htmlFor="password" className="login__label">Пароль</label>
        <input id="password" type="password" className="login__input input-email" name="password"
